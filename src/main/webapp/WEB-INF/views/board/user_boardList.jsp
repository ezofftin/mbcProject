		...
		<table class="table">
		   ...
		   <tbody>
				<c:forEach var="dto" items="${noticeList}">
					<tr>
						<td style="text-decoration:none; color:black">	<!-- a href= 는 Get방식 --> <!-- 페이징처리 현재페이지로 이동값 viewPage를 pDto.viewPage로 설정 -->
							<a href="<c:url value='viewBoard.do?bid=${dto.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyword=${pDto.keyword}&cntPerPage=${pDto.cntPerPage}'/>" style="text-decoration:none; font-weight:bold; color:black"><c:out value="${dto.subject}"/>
								<%-- <b>[댓글 : ${dto.replyCnt}]</b> --%>
							</a>
						</td>
						<%-- <td>
