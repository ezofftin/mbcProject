...
<!-- ------------ -->
<form action="reserveInfo.do" method="post" enctype="multipart/form-data">
	<div class="container">
	<table class="table table-border" >
		<tbody>
			<tr>
				<!-- 예약번호:hidden -->
				<td>
				<input type="text" class="form-control form-control-sm" name="reserveNum" id="reserveNum" readonly/>
				</td>
			</tr>
			<tr>
				<td>예약자 번호</td>
				<td>
				<input type="text" class="form-control form-control-sm" name="memberNum" id="memberNum" value="${memberList.memberNum}" readonly/>
				</td>
			</tr>
			<tr>
				<td>호텔번호</td>
				<td>
				<input type="text" class="form-control form-control-sm" name="hotelNum" id="hotelNum" value="${hotelDto.hotelNum}" readonly/>
				</td>
			</tr>
			<tr>
				<td>예약자명</td>
				<td>
				<input type="text" class="form-control form-control" id="memberName" name="memberName" value="${memberDto.memberName}" readonly/>
				</td>
			</tr>
			<tr>
				<td>호텔명</td>
